        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-in">
            <div className="relative">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 bg-card rounded-lg p-4 shadow-medium animate-float">
              ...
              <div className="absolute -bottom-4 -left-4 bg-card rounded-lg p-4 shadow-medium animate-float" style={{ animationDelay: '1s' }}>
                <div className="flex items-center gap-2">
